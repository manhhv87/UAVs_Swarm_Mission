    ...
    while True:
        ...
        # If command is not 'Break', and status_waitForCommand is true, execute command immediately.
            ...
            if status_waitForCommand == True:
                ...
                print('{} - Omit immediate command \'{}\', because status_waitForCommand is False!'.format(
...
def curvature_flight_body_frame(horizontal_linear_speed, radius_of_curvature, total_turn_degree_deg, velocity_z, atom_segment):
    print('\n')
    print('{} - Calling function curvature_flight_body_frame(horizontal_linear_speed={}, radius_of_curvature={}, velocity_z={})'.format(
        time.ctime(), horizontal_linear_speed, radius_of_curvature, velocity_z))
