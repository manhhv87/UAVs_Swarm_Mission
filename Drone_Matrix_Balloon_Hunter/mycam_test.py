...
# Start detecting.
act_detecting = od.Thread_detect_balloon(
    cameraL, cameraR, red_color_range_pair)
act_detecting.start()
...
act_detecting.start_video_recording(
    framePath=path, isPlotOriginalFrame=False, displayOrSave='save')
for i in xrange(100):
